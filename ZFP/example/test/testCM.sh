...
# This file is to test ZFP filter created with the CMake process via Spack.
...
REPACKTEST h5repack_layout.h5 ud_convert.h5repack_layout.h5 -v -f UD=32013,1,0,0 -l CHUNK=4x8
