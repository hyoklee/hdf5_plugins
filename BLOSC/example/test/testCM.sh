...
# This file is to test BLOSC filter created with the CMake process via Spack.
srcdir=..
builddir=.
verbose=yes
nerrors=0
...
REPACKTEST h5repack_layout.h5 ud_convert.h5repack_layout.h5 -v -f UD=32001,0,0
