...
# This file is to test LZ4 filter created with the CMake process via Spack.
...
REPACKTEST h5repack_layout.h5 ud_convert.h5repack_layout.h5 -v -f UD=32004,1,1,3 -l CHUNK=4x8
